...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 29 12:00:40 2018
...
# File operations
#
def get_data_fnames(data_path, keyword):
    """
    Get the file names under a path containg a keyword
    """
    data_fnames = [data_path + f for f in listdir(data_path) if keyword in f]
